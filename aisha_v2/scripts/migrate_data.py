...
from aisha_v2.app.database.config import async_engine as new_engine
from aisha_v2.app.database.models import Avatar, AvatarPhoto, User, UserBalance, UserState
