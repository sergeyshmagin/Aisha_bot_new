...
from aisha_v2.app.services.audio_processing.types import AudioConverter, AudioMetadata
...
class PydubAudioConverter(AudioConverter):
    ...
    async def convert_to_mp3(self, audio_data: bytes) -> bytes:
        ...
        Returns:
            bytes: Конвертированные аудио данные в MP3
            
        Raises:
            AudioProcessingError: При ошибке конвертации
        """
        try:
