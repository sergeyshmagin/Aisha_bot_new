...
from aisha_v2.app.database.models import UserTranscript, User
...
class TestTranscriptModels:
    ...
    def test_user_model_import(self):
        ...
        from aisha_v2.app.database.models import User
...
class TestTranscriptIntegration:
    ...
    def test_transcript_texts_and_keyboards(self):
        ...
        try:
            from aisha_v2.app.texts.transcript import TranscriptTexts
            from aisha_v2.app.keyboards.transcript import get_transcript_menu
