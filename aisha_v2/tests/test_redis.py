...
@pytest.mark.asyncio
async def test_redis_json(redis_client: aioredis.Redis):
...
@pytest.mark.asyncio
async def test_redis_ttl(redis_client: aioredis.Redis):
...
@pytest.mark.asyncio
async def test_redis_hash(redis_client: aioredis.Redis):
