...
async def format_transcript_with_gpt(
    ...
    restriction = "Внимание: Отвечай только по теме задачи. Если вопрос не по теме, отвечай: 'Я могу отвечать только по теме встречи/задачи.'"
    ...
    await client.beta.threads.messages.create(
        thread_id=thread_id, role="user", content=f"{prompt}\n\n{transcript}"
    )
