...
user_session = (
    {}
)  # user_id -> dict: wizard_message_ids, last_wizard_state, uploaded_photo_msgs, last_error_msg, last_info_msg_id
...
user_media_group_msg_ids = {}  # user_id -> media_group_id -> [message_id, ...]
