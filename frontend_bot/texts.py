...
# Тексты сообщений для бота (можно расширять и использовать для локализации)

PHOTO_REQUIREMENTS_TEXT = (
    "ℹ️ <b>Требования к фото для генерации аватара:</b>\n"
    "• Минимум 16, максимум 24 фото.\n"
    "• Разные ракурсы, фоны, одежда, освещение.\n"
    "• Не используйте фото с другими людьми или гримасами.\n"
    "• Размер не менее 512x512 пикселей, формат JPEG/PNG.\n"
    "• Фото должны быть чёткими, без сильных фильтров.\n\n"
    "<b>Пожалуйста, отправьте свои фото для создания аватара!</b>"
)

# Пример: другие сообщения
# LIMIT_REACHED_TEXT = "Достигнут лимит фото..."
